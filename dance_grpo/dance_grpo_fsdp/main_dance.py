...
class TaskRunner:
    ...
    def run(self, config):
        ...
        val_dataset, val_collate_fn = create_rl_dataset(
...
def create_rl_dataset(data_paths, data_config, tokenizer, processor, is_train=True, max_samples: int = -1):
    """Create a dataset that parses pickapic JSON structure and extracts only the prompt field."""
    import json
    import os
    ...
    # Return both dataset and collate_fn
