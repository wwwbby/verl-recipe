...
from .configuration_mammothmoda2_qwen3_vl import (
...
class Qwen3VLVisionPatchMerger(nn.Module):
    def __init__(self, config: Mammothmoda2Qwen3VLVisionConfig, use_postshuffle_norm=False) -> None:
        super().__init__()
...
class Qwen3VLVisionAttention(nn.Module):
    def __init__(self, config: Mammothmoda2Qwen3VLVisionConfig) -> None:
        super().__init__()
...
class Qwen3VLTextRotaryEmbedding(nn.Module):
    ...
    def __init__(self, config: Mammothmoda2Qwen3VLTextConfig, device=None):
        super().__init__()
...
class Qwen3VLTextAttention(nn.Module):
    ...
    def __init__(self, config: Mammothmoda2Qwen3VLTextConfig, layer_idx: int):
        super().__init__()
        self.config = config
...
class Qwen3VLTextDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Mammothmoda2Qwen3VLTextConfig, layer_idx: int):
        ...
        if self.moe_enable:
            self.gen_mlp = Qwen3VLTextMLP(config)
        else:
            self.gen_mlp = None
...
class Qwen3VLPreTrainedModel(PreTrainedModel):
    config: Mammothmoda2Qwen3VLConfig
...
class Qwen3VLVisionModel(Qwen3VLPreTrainedModel):
    config: Mammothmoda2Qwen3VLVisionConfig
...
class Qwen3VLTextModel(Qwen3VLPreTrainedModel):
    config: Mammothmoda2Qwen3VLTextConfig
    _no_split_modules = ["Qwen3VLTextDecoderLayer"]

    def __init__(self, config: Mammothmoda2Qwen3VLTextConfig):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        gen_token_mask (`torch.BoolTensor` of shape `(batch_size, seq_len)`, *optional*):
            The mask of the generation tokens.
        """
...
class Mammothmoda2Qwen3VLCausalLMOutputWithPast(ModelOutput):
    r"""
...
class Mammothmoda2Qwen3VLForConditionalGeneration(Qwen3VLPreTrainedModel, GenerationMixin):
    _checkpoint_conversion_mapping = {}
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        logits = self.lm_head(hidden_states[:, slice_indices, :] if hidden_states.dim() == 3 else hidden_states)
        if self.extra_gen_vocab:
            gen_logits = self.gen_head(
                hidden_states[:, slice_indices, :] if hidden_states.dim() == 3 else hidden_states
            )
        ...
        return Mammothmoda2Qwen3VLCausalLMOutputWithPast(
            loss=loss,
            logits=logits,
            past_key_values=outputs.past_key_values,
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        if cache_position[0] != 0:
            ...
            model_inputs["gen_token_mask"] = None
